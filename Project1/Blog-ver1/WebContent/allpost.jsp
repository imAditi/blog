...
<link rel="icon" href="asset/group2/images/favicon.ico"
	type="image/x-icon">
<!-- date picker removed -->
...
<link rel="stylesheet" type="text/css"
	href="asset/group2/vendors/bootstrap.min.css">
...
<!-- Custom css -->
<link rel="stylesheet" type="text/css"
	href="asset/group2/css/style1.css" />
...
<script type="text/javascript"
	src="asset/group2/vendors/jquery-3.3.1.min.js"></script>
<script type="text/javascript"
	src="asset/group2/vendors/bootstrap.min.js"></script>
		...
		<header class="main-header">
			<div class="row">
				<div class="container-fluid">
					<div class="col-md-12">
						<div class="col-sm-4">
							<img src="asset/group2/images/yash-logo.svg"
								...
								<tbody>
									<c:forEach var="blogs" items="${blogs}">
										<tr>
											...
											<td class="${blogs.id}"><c:forEach var="category"
											...
											<td class="${blogs.id}"><c:out
													value="${blogs.created_at}"></c:out></td>
											<td><button
													style="border: 0px; background-color: #f9f9f9;"
													onclick="update(this,${blogs.id});">
													<img src="asset/group2/images/edit.svg" title="edit"
														width="15px" height="15px">
												</button> <a id="del" title="${blogs.id}"
												onclick="deletePost(${blogs.id});"> <img
													src="asset/group2/images/delete.svg" width="15px"
													height="15px">
											</a></td>
